...
import { MapPin, UserCog, UsersRound } from 'lucide-react';
  ...
  if (viewMode === 'list') {
    return (
      ...
      >
        ...
        {/* Column 5: Status */}
        <div className="min-w-0">
          <span className={`inline-flex text-xs font-medium px-2.5 py-0.5 rounded-full ${getStatusBadgeClass(partner.partner_status)}`}>
    ...
    >
      <div className="p-4">
        ...
        <div className="flex items-center justify-between gap-3 mb-2">
          ...
          <span className={`flex-shrink-0 text-xs font-medium px-2.5 py-0.5 rounded-full ${getStatusBadgeClass(partner.partner_status)}`}>
            {partner.partner_status}
          </span>
        </div>
